        ...
        if (!APP_DEMO) {
            ...
            switch($action) {
                ...
                case 'remove': {
                    ...
                    header("Location: /admin/stickers.php");
                    exit;
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="form-material m-t-40"  method="post" action="/admin/stickers.php" enctype="multipart/form-data">
...
<?php
    ...
    function draw($itemObj)
    {
        ...
        <tr data-id="<?php echo $itemObj['id']; ?>">
            ...
            <td><a href="/admin/stickers.php/?id=<?php echo $itemObj['id']; ?>&action=remove&access_token=<?php echo admin::getAccessToken(); ?>">Remove</a></td>
        </tr>
