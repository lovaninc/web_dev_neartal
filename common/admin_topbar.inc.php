                ...
                <li class="nav-item dropdown ">
                    ...
                    <div class="dropdown-menu dropdown-menu-right scale-up show">
                        <ul class="dropdown-user">
                            <li><a href="/admin/support.php"><i class="ti-email"></i> Support</a></li>
                            <li><a href="/admin/settings.php"><i class="ti-settings"></i> Settings</a></li>
                            <li role="separator" class="divider"></li>
                            <li><a href="/admin/logout.php/?access_token=<?php echo admin::getAccessToken(); ?>&continue=/"><i class="fa fa-power-off"></i> Logout</a></li>
                        </ul>
                    </div>
                </li>
